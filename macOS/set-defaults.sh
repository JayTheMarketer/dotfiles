...
# Note: if you’re in the UK, replace `USD` with `EUR`, `Inches` with
...
# Enable continuous spellchecking & auto-correct
...
defaults write com.apple.mail DraftsViewerAttributes -dict-add "SortedDecending" -string "no"
...
# Use an iTerm ported version of the Monokai Soda theme by default in Terminal.app
osascript <<EOD
...
tell application "Terminal"
	...
	local windowID
	set themeName to "Monokai Soda xterm-256color"
...
open "${DOTFILES}/iterm2/Monokai Soda.itermcolors"
